...
function Icon(_ref) {
  ...
  if (color && sourceType === 'external' && newDesignLanguage === true && isNewDesignLanguageColor(color)) {
    // eslint-disable-next-line no-console
    console.warn('Recoloring external SVGs is not supported with colors in the new design langauge. Set the intended color on your SVG instead.');
  }
...
var ComboBox = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(ComboBox, [{
    ...
    key: "getActionsWithIds",
    value: function getActionsWithIds(actions, before) {
      var navigableOptions = this.state.navigableOptions;
...
function assignOptionIds(options, comboBoxId) {
  return options.map(function (option, optionIndex) {
    return Object.assign(Object.assign({}, option), {
      id: "".concat(comboBoxId, "-").concat(optionIndex)
    });
  });
}
...
var ConnectedFilterControl = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(ConnectedFilterControl, [{
    ...
    value: function render() {
      ...
      var rightMarkup = rightPopoverableActions ? /*#__PURE__*/React__default.createElement("div", {
      ...
      }, /*#__PURE__*/React__default.createElement(Item$4, null, rightAction)) : null;
...
function Header$2(_ref) {
  ...
  var navigationMarkup = breadcrumbMarkup || paginationMarkup ? /*#__PURE__*/React__default.createElement("div", {
  ...
  _createClass(BaseResourceItem, [{
    ...
    value: function shouldComponentUpdate(nextProps, nextState) {
      var _a = nextProps.context,
          ...
          restNextProps = tslib.__rest(nextProps, ["context"]);

      var _b = this.props,
          _c = _b.context,
          selectedItems = _c.selectedItems,
          restContext = tslib.__rest(_c, ["selectedItems"]),
          restProps = tslib.__rest(_b, ["context"]);
...
var ResourceListInner = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(ResourceListInner, [{
    ...
    value: function render() {
      ...
      var headerMarkup = !showEmptyState && (showHeader || needsHeader) && this.listRef.current && /*#__PURE__*/React__default.createElement("div", {
      ...
      var emptyStateMarkup = showEmptyState ? /*#__PURE__*/React__default.createElement("div", {
